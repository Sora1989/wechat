!function t(e, r, n) {
    ...
    1: [function (t, e, r) {
        ...
        function l(t) {
            return T ? T : (T = c(I), T.oldValue = t, T)
        }
        ...
        c = t("./utils"), s = c.detectIE() || 0 / 0, 9 > s ? t("json2") : (window.MutationObserver = t("mutation-observer"), a = t("tree-mirror")), u = t("./info"), c = t("./utils"), i = t("./messaging_observer"), o = t("./server_imp_setting"), d = c.detectIOS() || 0 / 0, n = function () {
            ...
            return s = null, N = 3, p = [], r = {}, f = {}, E = {
                ...
                title: 1,
                use: 1
            }, v = {}, S = null, g = null, x = null, n = !0, e = ["TEXTAREA", "HTML", "BODY"], O = ["button", "submit"], C = ["A", "BUTTON", "INPUT", "IMG"], w = ["I", "SPAN", "EM", "svg"], y = ["A", "BUTTON"], b = y, m = ["radio", "checkbox"], t.prototype.setPageGroup = function (t) {
                ...
                if (o = [], d = !0, t.leaf) 1 === t.nodeType && ((null != (h = t.attributes) ? h.href : void 0) || null != t.text || null != t.obj) && (s = this.nodeMessage(t, !0), e > 1 && (s.idx = t.idx), o.push(s)); else if (0 === t.childNodes.length && -1 === c.indexOf(C, t.tagName)) ; else {
                ...
                s = {
                    ...
                    return t.which > 1 || (x = +Date.now(), g === x) ? void 0 : (g = x, v = {
                        time: x,
                    ...
                    var e;
                    return e = +Date.now() - v.time, 1e3 > e ? clearTimeout(S) : void 0
                }, d = function (t, e) {
                    var r;
                    ...
                    return function (r) {
                        ...
                        if (!document.body.className.match(/\bvds-entrytext\b/)) {
                            ...
                            if (a = d.tagName, "click" === r.type) {
                                ...
                                if ("INPUT" === a && -1 === c.indexOf(O, d.type)) return;
                ...
                if (n = {}, S = e.tagName, "IMG" === S ? (null != (C = e.src) ? C.length : void 0) > 0 && -1 === e.src.indexOf("data:image") && (n.h = e.src) : c.hasAttr(e, "href") && (i = e.getAttribute("href"), i && 0 !== i.indexOf("javascript") && (n.h = c.normalizePath(i.slice(0, 320)))), c.hasAttr(e, "data-growing-title") && e.getAttribute("data-growing-title").length > 0) n.v = e.getAttribute("data-growing-title"); else if (c.hasAttr(e, "title") && e.getAttribute("title").length > 0) n.v = c.processText(e.getAttribute("title")); else if ("click" === t) if (u.isLeaf(e)) if ("IMG" === S) e.alt ? n.v = e.alt : n.h && (s = n.h.split("?")[0], a = s.split("/"), a.length > 0 && (n.v = a[a.length - 1])); else if ("INPUT" === S && -1 !== c.indexOf(O, e.type)) n.v = c.processText(e.value); else if ("svg" === S) for (N = e.childNodes, o = 0, w = N.length; w > o; o++) r = N[o], 1 === r.nodeType && "use" === r.tagName && c.hasAttr(r, "xlink:href") && (n.v = r.getAttribute("xlink:href")); else E = "", null != e.textContent ? E = e.textContent.replace(/[\n \t]+/g, " ").trim() : null != e.innerText && (E = e.innerText.replace(/[\n \t]+/g, " ").trim()), E.length > 0 && (E.length < 50 ? n.v = c.processText(E) : "A" === S && (n.v = c.processText(E.slice(0, 50)))); else -1 !== c.indexOf(b, S) ? n.v = u.containerElemContent(e) : u.isParentOfLeaf(e) && (n.v = c.parentOfLeafText(e)); else if ("change" === t) "TEXTAREA" !== S && ("INPUT" === S ? -1 !== c.indexOf(m, e.type) ? (n.v = c.processText(e.value), l = e.parentNode, "LABEL" === l.tagName ? h = l : "BODY" !== l.tagName && (l = l.parentNode, "LABEL" === l.tagName ? h = l : e.id && (v = l.getElementsByTagName("label"), function () {
                    var t, r, n;
                    for (n = [], t = 0, r = v.length; r > t; t++) g = v[t], n.push(g["for"] === e.id);
                    return n
                }() && (h = g))), null != h && (f = u.containerElemContent(h), (null != f ? f.length : void 0) > 0 && (n.obj = f + " (" + e.checked + ")"))) : "password" !== e.type && (c.hasAttr(e, "growing-track") || c.hasAttr(e, "data-growing-track")) && (n.v = c.processText(e.value)) : "SELECT" === S && (n.v = c.processText(e.value), 1 === e.selectedOptions.length && null != e.selectedOptions[0].label && (n.obj = e.selectedOptions[0].label))); else if ("submit" === t) for (x = e.getElementsByTagName("input"), p = 0, y = x.length; y > p; p++) d = x[p], ("search" === d.type || "text" === d.type && ("q" === d.id || -1 !== d.id.indexOf("search") || -1 !== d.className.indexOf("search") || "q" === d.name || -1 !== d.name.indexOf("search"))) && (n.x = u.path(d).xpath, n.v = c.processText(d.value.trim()));
                return n
        ...
        u = t("./guid"), a = t("cookie"), p = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, l = ["I", "SPAN", "EM", "svg"], d = p.detectIE() || 0 / 0, i = function () {
            ...
            user: function () {
                ...
                if (null == e && (e = !1), a = "", g = !1, n = {}, h = !1, c = !1, O = void 0, s = 0, y = [], o = [], t === document) return {isIgnore: !0};
                for (r = new i(t); "body" !== r.name && "html" !== r.name && (n = {
                    x: r.path(),
                    h: r.href,
                    v: this.containerElemContent(r.node)
                }, y.push(n.x), m = r.path(), r.isIgnore && (g = !0), !h && r.hasObj() && (h = !0, d = r.grObj), c || (r.hasIdx() ? (c = !0, u = r.grIdx) : (N = r.path(), (-1 !== N.indexOf("/dl") || -1 !== N.indexOf("/tr") || -1 !== N.indexOf("/li")) && (c = !0, u = this.index(r.node)))), b = r.node.parentNode, e && "" !== a && (-1 !== p.indexOf(f, r.node.tagName) || r.isContainer()) && (h ? n.obj = d : p.hasAttr(r.node.parentNode, "data-growing-info") && (n.obj = r.node.parentNode.getAttribute("data-growing-info")), n.x = s, o.push(n)), a = m + a, s++, b && b.tagName);) r = new i(b), 1 === s && (O = r.node);
                for (y.reverse(), l = 0, v = o.length; v > l; l++) w = o[l], w.x = y.slice(0, s - w.x).join(""), c && (w.idx = u), h && (w.obj = d);
                return C = {
                    xpath: a,
                    containerMessage: o,
                    isIgnore: g
                }, h && (C.obj = d), c && (C.idx = u), O && (C.pnode = O), C
            }, index: function (t) {
                var e, r, n, i, o, a, s;
        ...
        n = t("./sender"), a = t("./utils"), o = t("./info"), i = function () {
            ...
            var e;
            return e = "0.79", t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
                imp: !0,
                hashtag: !1,
                touch: !1,
                bot: !0,
                ...
                for (var i, o, a, s = [], u = /\s/, d = "Invalid or unsupported selector syntax.", c = 1, h = 2, l = 3, f = 4, p = 5, g = 6, b = 7, y = 8, O = 9, C = 10, N = 11, x = 12, S = 13, E = 14, A = c, I = 0; I < e.length;) {
                    ...
                    switch (A) {
                        case c:
                            ...
                            if ("." == T) {
                                r(), n(), i.tagName = "*", o.attrName = "class", o.contains = !0, A = f;
                                break
                            }
                            if ("#" == T) {
                                r(), n(), i.tagName = "*", o.attrName = "id", A = f;
                                break
                            }
                            if ("[" == T) {
                                r(), n(), i.tagName = "*", o.attrName = "", A = g;
                                break
                            }
                            if (T.match(u)) break;
                            throw Error(d);
                        case h:
                            ...
                            if ("." == T) {
                                n(), o.attrName = "class", o.contains = !0, A = f;
                                break
                            }
                            if ("#" == T) {
                                n(), o.attrName = "id", A = f;
                            ...
                            if (e += "/", w.childNodes.length > 0) {
                                ...
                                for (var E = w.firstChild; E; E = E.nextSibling) {
                                    if (O = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null, C = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1, 1 === E.nodeType) {
                                        ...
                                        -1 !== i.indexOf(E.tagName) && (N += 1, C = N), E.hasAttribute("data-growing-idx") && (N = parseInt(E.getAttribute("data-growing-idx")), C = N), E.hasAttribute("data-growing-info") && (O = E.getAttribute("data-growing-info"))
                                    }
                                    var A = this.serializeNode(E, e, N > 0 && C > 0 ? N : r, O || d);
                                    if (null === A) 3 != E.nodeType && (y = !1); else if ("undefined" != typeof A.childNodes) {
                                        y = !1, b = !0;
                                        for (var I = 0; I < A.childNodes.length; I++) if (A.childNodes[I].tagName) {
                                            b = !1;
                                            break
                                        }
                                        N > 0 && C > 0 ? A.idx = N : r && (A.idx = r), O ? A.obj = O : d && (A.obj = d), g.childNodes.push(A)
                                    } else {
